...
public class BubbleSortGenApp {
    public static void main(String[] args) throws Exception {
        ...
        // Membuat objek yang akan mengurutkan data dengan BubbleSortGeneric
        ...
        ti.startTiming();
        result.bubbleSortGeneric(arr);
        ti.endTiming();

        // Mampilkan data yang sudah terurut
        arr.display();
        System.out.println("\n=========Kompleksitas waktu Bubble Sort Generic=========");
        System.out.printf("Waktu yang diperlukan bubble sort untuk mengurutkan kata: %.3f ms \n", (double) ti.getElapsedTime());
