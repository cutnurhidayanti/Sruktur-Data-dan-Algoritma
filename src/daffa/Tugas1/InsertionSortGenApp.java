...
public class InsertionSortGenApp {
    public static void main(String[] args) throws Exception {
        ...
        // Membuat objek yang akan mengurutkan data dengan InsertionSortGeneric
        ...
        ti.startTiming();
        result.insertionSortGeneric(arr);
        ti.endTiming();

        // Mampilkan data yang sudah terurut
        arr.display();
        System.out.println("\n=========Kompleksitas waktu Insertion Sort Generic=========");
        System.out.printf("Waktu yang diperlukan insertion sort untuk mengurutkan kata: %.3f ms \n", (double) ti.getElapsedTime());
